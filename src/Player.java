...
public class Player {
    ...
    public void selectChar(){
        ...
        System.out.println("-----------------------------");
        System.out.println("Lutfen Secmek Istediginiz Karakterin ID'sini Giriniz: ");
    ...
    public boolean isWin(Player player){
        return getInventory().isFirewood()&&getInventory().isFood()&&getInventory().isWater();
    }
